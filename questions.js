window.STUDY_QUESTIONS = [
  ...
  {
    "id": "replacement-week-01-accessible-alt-text",
    "type": "open",
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "A chart shows that delays rise sharply after 18:00. Which alt text is most useful to someone who cannot see the chart?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "Useful alt text communicates the chart's relevant pattern instead of describing its filename or merely announcing that an image exists.",
    "source": {
    ...
    "needsReview": false,
    "idealAnswer": "Flight delays stay fairly low earlier in the day and rise sharply after 18:00.. Useful alt text communicates the chart's relevant pattern instead of describing its filename or merely announcing that an image exists.",
    "keyPoints": [
      "Gives the answer: Flight delays stay fairly low earlier in the day and rise sharply after 18:00.",
  ...
  {
    "id": "drill-week-01-1-application",
    "type": "single",
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "A document-level setting uses `echo: true`, but one code cell uses `#| echo: false`. What happens for that cell?",
    "options": [
      "Its source is shown because YAML always wins",
      "The cell is not evaluated",
      "The entire document stops rendering",
      "Its source is hidden and the cell still runs"
    ],
    "correct": 3,
    "explanation": "A cell-level option overrides the document default for that cell; `echo` changes source display, not evaluation.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk1_why_data_vis.html",
  ...
  {
    "id": "drill-week-01-2-application",
    "type": "open",
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "When is `echo: fenced` useful in a Quarto teaching document?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "`echo: fenced` displays the source as a fenced code block, including cell options.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk1_why_data_vis.html",
    ...
    "needsReview": false,
    "idealAnswer": "When readers should see the source together with its cell-option lines. `echo: fenced` displays the source as a fenced code block, including cell options.",
    "keyPoints": [
      "Gives the answer: When readers should see the source together with its cell-option lines",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 88
  },
  ...
  {
    "id": "drill-week-01-3-application",
    "type": "single",
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "A Quarto table of contents is enabled but a section is missing from it. What should be checked first?",
    "options": [
      "Whether every code cell has `echo: true`",
      "Whether the plot uses a zero baseline",
      "Whether the document contains a factor",
      "Whether the section uses a proper Markdown heading"
    ],
    "correct": 3,
    "explanation": "Quarto builds the table of contents from the document's heading structure.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk1_why_data_vis.html",
  ...
  },
  {
    ...
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "A figure is labelled `#fig-sales` in a Quarto document. Which reference should be used in the prose so Quarto can number and link the figure?",
    "options": [
      "@fig-sales",
      "#fig-sales",
      "[fig-sales]",
    ...
    "correct": 0,
    "explanation": "Quarto cross-references a labelled figure with the `@fig-...` form.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk1_why_data_vis.html",
  ...
  {
    "id": "drill-week-01-4-application",
    "type": "single",
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "A chart uses tilted 3D bars to compare exact values. What is the most defensible redesign?",
    "options": [
      "Remove the numeric axis",
      "Use flat 2D marks on a common scale",
      "Increase the perspective angle",
      "Add shadows to make depth clearer"
    ],
    "correct": 1,
    "explanation": "Perspective changes apparent lengths and positions; flat marks on a common scale support comparison.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk1_why_data_vis.html",
  ...
  },
  {
    ...
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "A chart already labels each line directly at its endpoint. What is the strongest reason to remove the separate colour legend?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "Direct labels can reduce lookup effort when they clearly identify each series.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk1_why_data_vis.html",
    ...
    "needsReview": false,
    "idealAnswer": "Readers no longer need to look back and forth between lines and legend keys. Direct labels can reduce lookup effort when they clearly identify each series.",
    "keyPoints": [
      "Gives the answer: Readers no longer need to look back and forth between lines and legend keys",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 93
  },
  {
    "id": "drill-week-01-5-application",
    "type": "single",
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "Two values differ only slightly and the difference—not magnitude from zero—is the message. Which design avoids truncating bar lengths?",
    "options": [
      "Use bars whose baseline starts at the smaller value",
      "Use 3D bars to magnify the gap",
      "Remove the axis labels",
      "Use points or a dumbbell plot on a clearly labelled scale"
    ],
    "correct": 3,
    "explanation": "A position-based display can focus on a small difference without using truncated bar length as the encoding.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk1_why_data_vis.html",
  ...
  },
  {
    ...
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "Which image description is most useful as alt text in a data report?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "Useful alt text communicates the information needed to understand the figure rather than its file metadata.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk1_why_data_vis.html",
    ...
    "needsReview": false,
    "idealAnswer": "A concise statement of the figure's relevant content or takeaway. Useful alt text communicates the information needed to understand the figure rather than its file metadata.",
    "keyPoints": [
      "Gives the answer: A concise statement of the figure's relevant content or takeaway",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 95
  },
  {
    "id": "drill-week-01-6-application",
    "type": "single",
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "A figure label is `#fig-sales`, but the prose contains `#fig-sales` rather than a cross-reference. What change is needed?",
    "options": [
      "Rename the figure to `sales.png`",
      "Write `@fig-sales` in the prose",
      "Write `toc: sales` in YAML",
      "Set `eval: false` on the figure cell"
    ],
    "correct": 1,
    "explanation": "The label declaration uses `#fig-sales`; prose references use `@fig-sales`.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk1_why_data_vis.html",
  ...
  {
    "id": "drill-week-02-7-application",
    "type": "single",
    "week": "week-02",
    "topic": "R vectors, factors, and subsetting",
    "prompt": "Given `x <- c(4, NA, 9, 2)`, what does `x[!is.na(x) & x > 3]` return?",
    "options": [
      "4, NA, and 9",
      "NA only",
      "2 only",
    ...
    "correct": 3,
    "explanation": "The logical index requires values to be non-missing and greater than 3.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk2_bilbos_ledgers.html",
  ...
  {
    "id": "drill-week-02-8-application",
    "type": "open",
    "week": "week-02",
    "topic": "R vectors, factors, and subsetting",
    "prompt": "A filter uses `x == NA` to find missing elements and returns no `TRUE` matches. What is the error in that test?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "`NA` represents an unknown value, so equality with it is unknown rather than `TRUE` or `FALSE`.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk2_bilbos_ledgers.html",
    ...
    "needsReview": false,
    "idealAnswer": "Comparisons with `NA` produce `NA`; missingness must be tested with `is.na()`. `NA` represents an unknown value, so equality with it is unknown rather than `TRUE` or `FALSE`.",
    "keyPoints": [
      "Gives the answer: Comparisons with `NA` produce `NA`; missingness must be tested with `is.na()`",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 100
  },
  ...
  {
    "id": "drill-week-02-9-application",
    "type": "open",
    "week": "week-02",
    "topic": "R vectors, factors, and subsetting",
    "prompt": "What is invalid about the index `x[c(1, -3)]`?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "Positive positions select while negative positions exclude, so R does not allow them to be mixed in one subscript except for zero.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk2_bilbos_ledgers.html",
    ...
    "needsReview": false,
    "idealAnswer": "Positive and negative subscripts cannot be mixed except with zero. Positive positions select while negative positions exclude, so R does not allow them to be mixed in one subscript except for zero.",
    "keyPoints": [
      "Gives the answer: Positive and negative subscripts cannot be mixed except with zero",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 102
  },
  ...
  {
    "id": "drill-week-02-10-application",
    "type": "single",
    "week": "week-02",
    "topic": "R vectors, factors, and subsetting",
    "prompt": "A factor has levels `low < medium < high`. Which statement about `rating > 'medium'` is correct?",
    "options": [
      "It identifies observations at the `high` level",
      "It compares labels alphabetically",
      "It is invalid for every factor",
      "It converts the factor to numeric scores automatically"
    ],
    "correct": 0,
    "explanation": "An ordered factor uses its declared level order for comparisons.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk2_bilbos_ledgers.html",
  ...
  },
  {
    ...
    "week": "week-02",
    "topic": "R vectors, factors, and subsetting",
    "prompt": "A vector `x` contains several missing values. Which expression returns the number of missing elements?",
    "options": [
      "x == NA",
      "sum(is.na(x))",
      "is.na(x)",
    ...
    "correct": 1,
    "explanation": "`is.na(x)` marks missing elements and `sum()` counts the resulting `TRUE` values.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk2_bilbos_ledgers.html",
  ...
  {
    "id": "drill-week-02-11-application",
    "type": "single",
    "week": "week-02",
    "topic": "R vectors, factors, and subsetting",
    "prompt": "In `case_match(x, 'A' ~ 1, 'B' ~ 2, .default = 0)`, what is returned for an unlisted value?",
    "options": [
      "The original value",
      "An error before matching begins",
      "0",
      "NA in every case"
    ],
    "correct": 2,
    "explanation": "`.default` supplies the output for values not matched by an explicit case.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk2_bilbos_ledgers.html",
  ...
  {
    "id": "drill-week-02-12-application",
    "type": "single",
    "week": "week-02",
    "topic": "R vectors, factors, and subsetting",
    "prompt": "Values are `10, 10, 8`. What ranks does `dense_rank(desc(value))` assign in row order?",
    "options": [
      "1, 1, 2",
      "1, 1, 3",
      "2, 2, 1",
    ...
    "correct": 0,
    "explanation": "Descending dense ranks give tied maxima rank 1 and the next distinct value rank 2 without a gap.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk2_bilbos_ledgers.html",
  ...
  },
  {
    ...
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "What does `rename_with(toupper, where(is.numeric))` change?",
    "options": [
      "The order of numeric rows",
      "The names of numeric columns",
      "The values in numeric columns",
      "Only rows containing numbers"
    ],
    "correct": 1,
    "explanation": "`rename_with()` applies a naming function to selected column names without changing their values.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
  ...
  {
    "id": "drill-week-03-13-application",
    "type": "single",
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "A pipeline must remove delayed flights and then add delay in hours. Which verb order matches that task?",
    "options": [
      "`arrange()` followed by `rename()`",
      "`summarize()` followed by `pivot_wider()`",
      "`filter()` followed by `mutate()`",
      "`mutate()` followed by `select()`"
    ],
    "correct": 2,
    "explanation": "`filter()` selects rows; `mutate()` creates or changes columns.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  {
    "id": "drill-week-03-14-application",
    "type": "single",
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "After `summarize(mean_delay = mean(delay, na.rm = TRUE), .by = carrier)`, what determines the number of result rows?",
    "options": [
      "The number of distinct carrier values",
      "The number of input flights",
      "The number of numeric columns",
      "The number of missing delay values"
    ],
    "correct": 0,
    "explanation": "`.by = carrier` produces one summary row for each carrier group.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  },
  {
    ...
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "Which dplyr call returns the three rows with the largest values of `score`, including ties only when requested?",
    "options": [
      "select(score, n = 3)",
      "slice_max(score, n = 3)",
      "arrange(score, n = 3)",
      "summarize(max(score), n = 3)"
    ],
    "correct": 1,
    "explanation": "`slice_max()` selects rows with the largest values and provides an explicit `with_ties` control.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  {
    "id": "drill-week-03-15-application",
    "type": "single",
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "A table has columns `Jan`, `Feb`, and `Mar`, and you need one `month` column plus one `sales` column. Which transformation is needed?",
    "options": [
      "`inner_join()`",
      "`relocate()`",
      "`pivot_longer()`",
    ...
    "correct": 2,
    "explanation": "`pivot_longer()` gathers several measure columns into name and value columns.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  {
    "id": "drill-week-03-16-application",
    "type": "single",
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "Which join finds rows in `orders` whose customer key has no match in `customers`?",
    "options": [
    ...
    "correct": 0,
    "explanation": "`anti_join()` returns rows from the left input without a match in the right input.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  {
    "id": "drill-week-03-17-application",
    "type": "single",
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "A key occurs twice in `x` and three times in `y`. How many rows can an inner join produce for that key?",
    "options": [
      "3",
      "2",
      "6",
    ...
    "correct": 2,
    "explanation": "A many-to-many match forms every matching pair, so two left rows times three right rows gives six rows.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  {
    "id": "drill-week-03-18-application",
    "type": "single",
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "Why choose `map_dbl()` instead of `map()` when every iteration should return one number?",
    "options": [
      "It enforces and returns a double vector",
      "It modifies the input list in place",
      "It automatically groups the data",
      "It skips every missing input"
    ],
    "correct": 0,
    "explanation": "A typed map variant checks that each result can form the requested atomic vector type.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  {
    "id": "drill-week-03-19-application",
    "type": "single",
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "Inside `mutate(across(where(is.numeric), scale, .names = '{.col}_z'))`, what does `.names` control?",
    "options": [
      "Order of join matches",
      "Values treated as missing",
      "Names of the generated columns",
      "Rows included in each group"
    ],
    "correct": 2,
    "explanation": "The `.names` template controls names created by `across()`.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  {
    "id": "drill-week-03-20-application",
    "type": "open",
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "A table has one row per person and separate `height` and `weight` columns. Which result indicates an accidental misuse of `pivot_wider()`?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "Turning measure columns into rows requires `pivot_longer()`; `pivot_wider()` moves values in the opposite direction.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
    ...
    "needsReview": false,
    "idealAnswer": "The table becomes even wider instead of creating measurement rows. Turning measure columns into rows requires `pivot_longer()`; `pivot_wider()` moves values in the opposite direction.",
    "keyPoints": [
      "Gives the answer: The table becomes even wider instead of creating measurement rows",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 124
  },
  ...
  {
    "id": "drill-week-04-21-application",
    "type": "open",
    "week": "week-04",
    "topic": "ggplot layers and distributions",
    "prompt": "A global mapping sets `colour = species`, but one reference line must stay black. Where should black be specified?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "A fixed layer argument overrides inherited mapping for that layer without creating a colour scale value.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk4-tutorial-iris.html",
    ...
    "needsReview": false,
    "idealAnswer": "As a fixed argument in that reference-line layer. A fixed layer argument overrides inherited mapping for that layer without creating a colour scale value.",
    "keyPoints": [
      "Gives the answer: As a fixed argument in that reference-line layer",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 126
  },
  ...
  {
    "id": "drill-week-04-22-application",
    "type": "single",
    "week": "week-04",
    "topic": "ggplot layers and distributions",
    "prompt": "A line plot connects observations from different subjects. What mapping is commonly missing?",
    "options": [
      "`group = subject`",
    ...
    "correct": 0,
    "explanation": "A group mapping tells the line layer which observations belong to each separate path.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk4-tutorial-iris.html",
  ...
  {
    "id": "drill-week-04-23-application",
    "type": "single",
    "week": "week-04",
    "topic": "ggplot layers and distributions",
    "prompt": "Which geom compares several distributions using unfilled lines based on histogram bins?",
    "options": [
      "`geom_boxplot()`",
      "`geom_raster()`",
      "`geom_freqpoly()`",
    ...
    "correct": 2,
    "explanation": "A frequency polygon uses binned counts connected by lines and can compare groups without overlapping filled bars.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk4-tutorial-iris.html",
  ...
  {
    "id": "drill-week-04-24-application",
    "type": "single",
    "week": "week-04",
    "topic": "ggplot layers and distributions",
    "prompt": "Two histograms use different x ranges but must use the same interval width. Which argument should be held constant?",
    "options": [
      "`binwidth`",
      "`alpha`",
      "`linewidth`",
    ...
    "correct": 0,
    "explanation": "`binwidth` fixes the width of each histogram interval in data units.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk4-tutorial-iris.html",
  ...
  {
    "id": "drill-week-04-25-application",
    "type": "single",
    "week": "week-04",
    "topic": "ggplot layers and distributions",
    "prompt": "What does the total area under a standard density curve represent?",
    "options": [
      "The number of bins",
    ...
    "correct": 2,
    "explanation": "A probability density is normalized so its total area is one.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk4-tutorial-iris.html",
  ...
  {
    "id": "drill-week-04-26-application",
    "type": "single",
    "week": "week-04",
    "topic": "ggplot layers and distributions",
    "prompt": "What problem does `geom_jitter()` address in a plot of discrete x values?",
    "options": [
      "Points drawn exactly on top of one another",
      "Incorrect factor level labels",
      "Missing coordinate reference systems",
      "Unequal histogram bin widths"
    ],
    "correct": 0,
    "explanation": "Jitter adds small positional noise so coincident observations become visible.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk4-tutorial-iris.html",
  ...
  {
    "id": "drill-week-04-27-application",
    "type": "single",
    "week": "week-04",
    "topic": "ggplot layers and distributions",
    "prompt": "A second layer should use a summary table rather than the plot's original data. How is that supplied?",
    "options": [
      "Put the table name in `theme()`",
      "Use `coord_cartesian(data = summary_table)`",
      "Set `data = summary_table` in that layer",
      "Replace the x scale with the table"
    ],
    "correct": 2,
    "explanation": "Each layer can receive its own data while inheriting or defining suitable mappings.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk4-tutorial-iris.html",
  ...
  {
    "id": "drill-week-06-28-application",
    "type": "single",
    "week": "week-06",
    "topic": "Aesthetics, bars, rasters, and contours",
    "prompt": "A data frame already contains one row per category with a `total` column. Which bar layer uses those totals directly?",
    "options": [
      "`geom_col(aes(y = total))`",
      "`geom_bar()` with no y mapping",
      "`geom_count(aes(y = total))`",
      "`geom_histogram(aes(y = total))`"
    ],
    "correct": 0,
    "explanation": "`geom_col()` uses supplied y values rather than applying the count statistic.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk6-tutorial-mpg.html",
  ...
  {
    "id": "drill-week-06-29-application",
    "type": "open",
    "week": "week-06",
    "topic": "Aesthetics, bars, rasters, and contours",
    "prompt": "What does `position = 'fill'` do to stacked bars?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "The fill position normalizes each stack to one, displaying within-bar proportions.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk6-tutorial-mpg.html",
    ...
    "needsReview": false,
    "idealAnswer": "Scales each stack to a common height so segment proportions can be compared. The fill position normalizes each stack to one, displaying within-bar proportions.",
    "keyPoints": [
      "Gives the answer: Scales each stack to a common height so segment proportions can be compared",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 142
  },
  ...
  {
    "id": "drill-week-06-30-application",
    "type": "open",
    "week": "week-06",
    "topic": "Aesthetics, bars, rasters, and contours",
    "prompt": "Grid cells have unequal widths, but a plot uses `geom_raster()`. What assumption makes that geom unsuitable?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "Raster geometry is the optimized regular-grid case; unequal cells need a more general tile geometry.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk6-tutorial-mpg.html",
    ...
    "needsReview": false,
    "idealAnswer": "It assumes a regular grid of equal-sized cells. Raster geometry is the optimized regular-grid case; unequal cells need a more general tile geometry.",
    "keyPoints": [
      "Gives the answer: It assumes a regular grid of equal-sized cells",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 144
  },
  ...
  {
    "id": "drill-week-06-31-application",
    "type": "open",
    "week": "week-06",
    "topic": "Aesthetics, bars, rasters, and contours",
    "prompt": "Which layer displays filled regions between contour levels rather than contour lines only?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "`geom_contour_filled()` converts ranges of z into filled contour bands.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk6-tutorial-mpg.html",
    ...
    "needsReview": false,
    "idealAnswer": "`geom_contour_filled()`. `geom_contour_filled()` converts ranges of z into filled contour bands.",
    "keyPoints": [
      "Gives the answer: `geom_contour_filled()`",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 146
  },
  ...
  {
    "id": "drill-week-06-32-application",
    "type": "single",
    "week": "week-06",
    "topic": "Aesthetics, bars, rasters, and contours",
    "prompt": "A numeric code `1, 2, 3` represents three unordered groups. What should happen before mapping it to shape?",
    "options": [
      "Convert the code to a factor",
      "Take its logarithm",
      "Map it to continuous size",
      "Use it as a contour z value"
    ],
    "correct": 0,
    "explanation": "Shape is discrete, so numeric category codes should be represented as categorical values.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk6-tutorial-mpg.html",
  ...
  {
    "id": "drill-week-06-33-application",
    "type": "single",
    "week": "week-06",
    "topic": "Aesthetics, bars, rasters, and contours",
    "prompt": "A map compares population density, not population total. Which encoding avoids implying that larger regions contain more of the measured quantity?",
    "options": [
      "Use line width as an exact count",
      "Duplicate each region by its density",
      "Map density to colour rather than polygon area",
      "Scale polygon area by density"
    ],
    "correct": 2,
    "explanation": "Density is intensive; colour can encode its value without treating geographic area as accumulated amount.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk6-tutorial-mpg.html",
  ...
  },
  {
    ...
    "week": "week-08",
    "topic": "Scales and guides",
    "prompt": "What does the `expand` argument on a position scale control?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "Scale expansion adds configurable space beyond the data range at the ends of an axis.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
    ...
    "needsReview": false,
    "idealAnswer": "Padding between the data range and the plot boundary. Scale expansion adds configurable space beyond the data range at the ends of an axis.",
    "keyPoints": [
      "Gives the answer: Padding between the data range and the plot boundary",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 151
  },
  {
    "id": "drill-week-08-34-application",
    "type": "single",
    "week": "week-08",
    "topic": "Scales and guides",
    "prompt": "A continuous scale uses `oob = scales::squish`. What happens to values outside its limits?",
    "options": [
      "They are clamped to the nearest limit",
      "They create new factor levels",
      "They are all converted to zero",
      "They reverse the legend order"
    ],
    "correct": 0,
    "explanation": "The squish out-of-bounds handler moves values below or above the range to the nearest boundary.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk8_scales_and_guides_tutorial.html",
  ...
  {
    "id": "drill-week-08-35-application",
    "type": "single",
    "week": "week-08",
    "topic": "Scales and guides",
    "prompt": "Breaks are `c(0, 0.5, 1)` and labels are `c('0%', '50%', '100%')`. What must be true?",
    "options": [
      "Breaks must be character strings",
      "Limits are inferred only from label text",
      "Each break has a corresponding label",
      "Labels change the underlying values"
    ],
    "correct": 2,
    "explanation": "Manual label vectors must align with the break positions they describe.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk8_scales_and_guides_tutorial.html",
  ...
  {
    "id": "drill-week-08-36-application",
    "type": "open",
    "week": "week-08",
    "topic": "Scales and guides",
    "prompt": "A reviewer treats a log transformation as if it only changed axis text. What crucial effect have they missed?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "Scale transformations affect the mapping from data to position, whereas labels affect presentation.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk8_scales_and_guides_tutorial.html",
    ...
    "needsReview": false,
    "idealAnswer": "A transformation changes positions on the scale; formatting changes displayed text only. Scale transformations affect the mapping from data to position, whereas labels affect presentation.",
    "keyPoints": [
      "Gives the answer: A transformation changes positions on the scale; formatting changes displayed text only",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 156
  },
  {
    ...
    "week": "week-08",
    "topic": "Scales and guides",
    "prompt": "What does `na.value` control on a colour scale?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "`na.value` defines how missing values are displayed by the colour or fill scale.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk8_scales_and_guides_tutorial.html",
    ...
    "needsReview": false,
    "idealAnswer": "The colour used for missing mapped values. `na.value` defines how missing values are displayed by the colour or fill scale.",
    "keyPoints": [
      "Gives the answer: The colour used for missing mapped values",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 157
  },
  {
    "id": "drill-week-08-37-application",
    "type": "open",
    "week": "week-08",
    "topic": "Scales and guides",
    "prompt": "How can a colour legend be removed while keeping the colour mapping in the plot?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "Disabling a guide hides the legend without removing the scale mapping from marks.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk8_scales_and_guides_tutorial.html",
    ...
    "needsReview": false,
    "idealAnswer": "Use `guides(colour = 'none')` or the scale's `guide = 'none'`. Disabling a guide hides the legend without removing the scale mapping from marks.",
    "keyPoints": [
      "Gives the answer: Use `guides(colour = 'none')` or the scale's `guide = 'none'`",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 158
  },
  ...
  {
    "id": "drill-week-08-38-application",
    "type": "single",
    "week": "week-08",
    "topic": "Scales and guides",
    "prompt": "A manual colour scale has five factor levels but supplies only four colours. What is the problem?",
    "options": [
      "At least one level lacks an intended colour assignment",
      "The scale becomes continuous automatically",
      "The fifth level is removed from the data",
      "The plot changes to a raster"
    ],
    "correct": 0,
    "explanation": "A manual discrete scale needs values covering the levels that should be displayed.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk8_scales_and_guides_tutorial.html",
  ...
  {
    "id": "drill-week-08-39-application",
    "type": "single",
    "week": "week-08",
    "topic": "Scales and guides",
    "prompt": "Values represent change around zero. Which palette structure communicates both direction and distance from zero?",
    "options": [
      "A one-sided sequential palette with no midpoint",
      "A random set of greys",
      "A diverging palette centred at zero",
      "An unordered qualitative palette"
    ],
    "correct": 2,
    "explanation": "A diverging palette emphasizes deviations on both sides of a meaningful midpoint.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk8_scales_and_guides_tutorial.html",
  ...
  {
    "id": "drill-week-09-40-application",
    "type": "single",
    "week": "week-09",
    "topic": "Coordinates, facets, and themes",
    "prompt": "What is a major caution when converting bars to angles with `coord_polar()`?",
    "options": [
      "Angle and area comparisons are usually harder than aligned length comparisons",
      "The data frame is permanently converted to polar coordinates",
      "Faceting becomes impossible",
      "All scale labels become factors"
    ],
    "correct": 0,
    "explanation": "Polar bars replace aligned lengths with less precise angle or area judgments.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/week_09_coord_facets_and_themes_tutorial.html"
  ...
  {
    "id": "drill-week-09-41-application",
    "type": "open",
    "week": "week-09",
    "topic": "Coordinates, facets, and themes",
    "prompt": "What trade-off comes with `facet_wrap(scales = 'free_y')`?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "Free scales can reveal local variation at the cost of a shared visual reference.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/week_09_coord_facets_and_themes_tutorial.html"
    ...
    "needsReview": false,
    "idealAnswer": "Within-panel patterns may be clearer, but magnitudes are harder to compare across panels. Free scales can reveal local variation at the cost of a shared visual reference.",
    "keyPoints": [
      "Gives the answer: Within-panel patterns may be clearer, but magnitudes are harder to compare across panels",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 166
  },
  ...
  {
    "id": "drill-week-09-42-application",
    "type": "single",
    "week": "week-09",
    "topic": "Coordinates, facets, and themes",
    "prompt": "Which theme setting removes major grid lines without changing data or scales?",
    "options": [
      "`theme(panel.grid.major = element_blank())`",
      "`filter(panel.grid.major == FALSE)`",
      "`scale_y_continuous(grid = FALSE)`",
      "`coord_cartesian(grid = FALSE)`"
    ],
    "correct": 0,
    "explanation": "Grid lines are non-data components controlled by theme elements.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/week_09_coord_facets_and_themes_tutorial.html"
  ...
  {
    "id": "drill-week-09-43-application",
    "type": "single",
    "week": "week-09",
    "topic": "Coordinates, facets, and themes",
    "prompt": "In `coord_fixed(ratio = 2)`, how is one y unit drawn relative to one x unit?",
    "options": [
      "It is shown in two facet panels",
      "It receives two axis labels",
      "It occupies twice the screen distance",
      "It is divided by two in the data"
    ],
    "correct": 2,
    "explanation": "The fixed-coordinate ratio specifies the y-unit screen distance relative to the x-unit screen distance.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/week_09_coord_facets_and_themes_tutorial.html"
  ...
  {
    "id": "drill-week-09-44-application",
    "type": "single",
    "week": "week-09",
    "topic": "Coordinates, facets, and themes",
    "prompt": "A smoother must use all observations, but the viewer should inspect only x values from 20 to 40. Which approach preserves the fit?",
    "options": [
      "Add `coord_cartesian(xlim = c(20, 40))`",
      "Filter to x values from 20 to 40 first",
      "Set scale limits before the smoother",
      "Convert x to a factor"
    ],
    "correct": 0,
    "explanation": "Coordinate zoom occurs after statistics, so the smoother can still be fitted using the full data.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/week_09_coord_facets_and_themes_tutorial.html"
  ...
  {
    "id": "drill-week-10-45-application",
    "type": "single",
    "week": "week-10",
    "topic": "Geospatial vectors",
    "prompt": "Two `sf` layers describe the same area but use different coordinate reference systems. What should happen before overlaying them?",
    "options": [
      "Join them by row number",
      "Convert their coordinates to factors",
      "Transform one layer so both use a compatible CRS",
      "Drop both geometry columns"
    ],
    "correct": 2,
    "explanation": "Spatial operations require compatible coordinate systems; `st_transform()` converts coordinates to a target CRS.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk10_geospatial_vectors_tutorial.html",
  ...
  {
    "id": "drill-week-10-46-application",
    "type": "open",
    "week": "week-10",
    "topic": "Geospatial vectors",
    "prompt": "Coordinates are already expressed in one CRS, but a script calls `st_set_crs()` with another CRS. What is wrong with that operation?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "Assigning CRS metadata does not project existing coordinate values into a different system.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk10_geospatial_vectors_tutorial.html",
    ...
    "needsReview": false,
    "idealAnswer": "It changes the CRS label without recalculating coordinates. Assigning CRS metadata does not project existing coordinate values into a different system.",
    "keyPoints": [
      "Gives the answer: It changes the CRS label without recalculating coordinates",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 176
  },
  ...
  {
    "id": "drill-week-10-47-application",
    "type": "single",
    "week": "week-10",
    "topic": "Geospatial vectors",
    "prompt": "Which geometry type is appropriate for a road network?",
    "options": [
      "POLYGON only",
      "A numeric factor with no geometry",
      "LINESTRING or MULTILINESTRING",
      "POINT only"
    ],
    "correct": 2,
    "explanation": "Roads are linear features and are represented by line geometries.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk10_geospatial_vectors_tutorial.html",
  ...
  {
    "id": "drill-week-10-48-application",
    "type": "single",
    "week": "week-10",
    "topic": "Geospatial vectors",
    "prompt": "A point should inherit the district polygon that contains it. Which spatial relationship is the join based on?",
    "options": [
      "Containment or intersection of geometries",
      "Equality of unrelated row numbers",
      "Alphabetical order of district names",
      "Matching colour-scale labels"
    ],
    "correct": 0,
    "explanation": "A spatial join uses a geometric predicate such as within, contains, or intersects.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk10_geospatial_vectors_tutorial.html",
  ...
  {
    "id": "drill-week-10-49-application",
    "type": "open",
    "week": "week-10",
    "topic": "Geospatial vectors",
    "prompt": "Why are raw case counts often a poor choropleth measure when regions have very different populations?\n\nAnswer without options, then justify your answer in one sentence.",
    "explanation": "Normalizing by an appropriate denominator separates prevalence from the size of the population at risk.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk10_geospatial_vectors_tutorial.html",
    ...
    "needsReview": false,
    "idealAnswer": "Counts can mainly reflect population size; a relevant rate supports fairer comparison. Normalizing by an appropriate denominator separates prevalence from the size of the population at risk.",
    "keyPoints": [
      "Gives the answer: Counts can mainly reflect population size; a relevant rate supports fairer comparison",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 182
  },
  ...
  },
  {
    "type": "single",
    "week": "week-01",
    "prompt": "A plotted figure needs an automatically numbered caption that can be cross-referenced later. Which chunk option supplies the caption text?",
    "options": [
      "echo",
      "eval",
      "warning",
    ...
    "correct": 3,
    "explanation": "`fig-cap` supplies a figure caption; a labelled figure can then be referenced from the prose.",
    "id": "supplemental-wk01-single-figure-caption",
    "topic": "Quarto and visual communication",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
  ...
  },
  {
    "type": "single",
    "week": "week-02",
    "prompt": "A vector `species` contains many names. Which expression marks entries equal to either `'Human'` or `'Droid'`?",
    "options": [
    ...
    "correct": 3,
    "explanation": "`%in%` performs an elementwise membership test against the complete set of listed values.",
    "id": "supplemental-wk02-single-membership",
    "topic": "R vectors, factors, and subsetting",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
