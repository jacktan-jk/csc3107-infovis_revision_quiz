window.STUDY_QUESTIONS = [
  {
    ...
    "prompt": "A Quarto cell contains the code below. The code normally prints both the source and the message when rendered.\n\n```r\n#| label: hello-csc3107\n#| echo: false\nmessage(\"Hello, CSC3107\")\n```\n\nWith no document-level option overriding the cell, what appears in the rendered HTML?",
    "options": [
  ...
  },
  {
    ...
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "A Quarto cell contains the code below. Assume `#| echo: false` has been removed and no document-level option overrides the cell.\n\n```r\n#| label: hello-csc3107\n#| eval: false\nmessage(\"Hello, CSC3107\")\n```\n\nWhat appears in the rendered HTML?",
    "options": [
  ...
  {
    "id": "csv-lab-key-40-you-want-to-draw-the-world-map-and-fill-each-country-accordi",
    "type": "single",
    "week": "week-10",
    "topic": "Geospatial vectors",
    "prompt": "You want to draw the World map and fill each country according to its continent column. Which call does this?\n\nR\nlibrary(ggplot2)\nlibrary(tmap)\nggplot(World, aes(____)) + ____",
    "options": [
  ...
  },
  {
    ...
    "options": [
      ...
      "An sf object belongs to both the sf and data.frame classes and is characterised by a special (geometry list-column, which converts it back to a standard data.frame when dropped)",
  ...
  },
  {
    ...
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "A student answers the following question with **eval: false**:\n\n> Which Quarto cell option hides source code while still running the code?\n\nWrite a one- or two-sentence correction. State the better answer and explain the relevant rule or behavior.",
    "idealAnswer": "echo: false. echo: false suppresses displayed source while evaluation still happens.",
    "keyPoints": [
      "Names echo: false as the correct answer.",
      "Explains that echo: false suppresses displayed source while evaluation still happens."
    ],
    "explanation": "A complete correction identifies echo: false and applies this rule: echo: false suppresses displayed source while evaluation still happens.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk1_why_data_vis.html",
  ...
  },
  {
    ...
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "During revision, a classmate claims **include: false** is the answer to this question:\n\n> Which Quarto cell option stops code execution but can still show the source code?\n\nRespond as a tutor: give the correct answer, then justify it using the underlying concept.",
    "idealAnswer": "eval: false. eval: false prevents execution; it does not by itself hide the code.",
    "keyPoints": [
      "Names eval: false as the correct answer.",
      "Explains that eval: false prevents execution; it does not by itself hide the code."
    ],
    "explanation": "A complete correction identifies eval: false and applies this rule: eval: false prevents execution; it does not by itself hide the code.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk1_why_data_vis.html",
  ...
  },
  {
    ...
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "Evaluate this attempted answer.\n\nQuestion: Which Quarto option is most appropriate for a setup chunk that should run but show neither code nor output?\n\nAttempt: **eval: false**\n\nReplace the attempt with the correct answer and briefly explain why the replacement is correct.",
    "idealAnswer": "include: false. include: false runs the code but excludes code and output from the rendered document.",
    "keyPoints": [
      "Names include: false as the correct answer.",
      "Explains that include: false runs the code but excludes code and output from the rendered document."
    ],
    "explanation": "A complete correction identifies include: false and applies this rule: include: false runs the code but excludes code and output from the rendered document.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk1_why_data_vis.html",
  ...
  },
  {
    ...
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "A learner chose **Quarto embeds every local image into YAML** when asked: “Why should an image referenced with a relative path be submitted with the QMD file?”\n\nCorrect the learner without referring to option letters. Your response must name the correct result and the rule that produces it.",
    "idealAnswer": "The grader needs the file at that relative path. Relative paths only resolve if the referenced file is present in the submitted folder.",
    "keyPoints": [
      "Names The grader needs the file at that relative path as the correct answer.",
      "Explains that Relative paths only resolve if the referenced file is present in the submitted folder."
    ],
    "explanation": "A complete correction identifies The grader needs the file at that relative path and applies this rule: Relative paths only resolve if the referenced file is present in the submitted folder.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk1_why_data_vis.html",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "Visible bar lengths stop being proportional to values. Bar charts encode by length, so truncating the baseline distorts the visual ratio.",
    "keyPoints": [
      "Gives the answer: Visible bar lengths stop being proportional to values",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 93
  },
  {
    ...
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "A student answers the following question with **The chart cannot use labels**:\n\n> What is the main risk of a bar chart with a non-zero baseline?\n\nWrite a one- or two-sentence correction. State the better answer and explain the relevant rule or behavior.",
    "idealAnswer": "Visible bar lengths stop being proportional to values. Bar charts encode by length, so truncating the baseline distorts the visual ratio.",
    "keyPoints": [
      "Names Visible bar lengths stop being proportional to values as the correct answer.",
      "Explains that Bar charts encode by length, so truncating the baseline distorts the visual ratio."
    ],
    "explanation": "A complete correction identifies Visible bar lengths stop being proportional to values and applies this rule: Bar charts encode by length, so truncating the baseline distorts the visual ratio.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk1_why_data_vis.html",
  ...
  },
  {
    ...
    "week": "week-01",
    "topic": "Quarto and visual communication",
    "prompt": "During revision, a classmate claims **Points always imply zero baselines** is the answer to this question:\n\n> Why can a point chart sometimes use a narrow y-axis more safely than a bar chart?\n\nRespond as a tutor: give the correct answer, then justify it using the underlying concept.",
    "idealAnswer": "Point area is not the value encoding. Points use position rather than bar length or area as the main encoding.",
    "keyPoints": [
      "Names Point area is not the value encoding as the correct answer.",
      "Explains that Points use position rather than bar length or area as the main encoding."
    ],
    "explanation": "A complete correction identifies Point area is not the value encoding and applies this rule: Points use position rather than bar length or area as the main encoding.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk1_why_data_vis.html",
  ...
  },
  {
    ...
    "week": "week-02",
    "topic": "R vectors, factors, and subsetting",
    "prompt": "Evaluate this attempted answer.\n\nQuestion: In R, what does x[c(2, 4)] do?\n\nAttempt: **Drops the second and fourth elements**\n\nReplace the attempt with the correct answer and briefly explain why the replacement is correct.",
    "idealAnswer": "Returns the second and fourth elements. Numeric indexing with positive integers selects those positions.",
    "keyPoints": [
      "Names Returns the second and fourth elements as the correct answer.",
      "Explains that Numeric indexing with positive integers selects those positions."
    ],
    "explanation": "A complete correction identifies Returns the second and fourth elements and applies this rule: Numeric indexing with positive integers selects those positions.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk2_bilbos_ledgers.html",
  ...
  },
  {
    ...
    "week": "week-02",
    "topic": "R vectors, factors, and subsetting",
    "prompt": "A learner chose **The smallest value** when asked: “Which rank receives 1 when using min_rank(desc(value))?”\n\nCorrect the learner without referring to option letters. Your response must name the correct result and the rule that produces it.",
    "idealAnswer": "The largest value. desc() reverses the ordering before ranking.",
    "keyPoints": [
      "Names The largest value as the correct answer.",
      "Explains that desc() reverses the ordering before ranking."
    ],
    "explanation": "A complete correction identifies The largest value and applies this rule: desc() reverses the ordering before ranking.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk2_bilbos_ledgers.html",
  ...
  },
  {
    ...
    "week": "week-02",
    "topic": "R vectors, factors, and subsetting",
    "prompt": "A student answers the following question with **A numeric vector with decimals**:\n\n> What does factor() primarily create?\n\nWrite a one- or two-sentence correction. State the better answer and explain the relevant rule or behavior.",
    "idealAnswer": "A categorical vector with levels. Factors store categorical values using a fixed set of levels.",
    "keyPoints": [
      "Names A categorical vector with levels as the correct answer.",
      "Explains that Factors store categorical values using a fixed set of levels."
    ],
    "explanation": "A complete correction identifies A categorical vector with levels and applies this rule: Factors store categorical values using a fixed set of levels.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk2_bilbos_ledgers.html",
  ...
  },
  {
    ...
    "week": "week-02",
    "topic": "R vectors, factors, and subsetting",
    "prompt": "During revision, a classmate claims **To remove all missing values** is the answer to this question:\n\n> Why use fct_recode() in a tutorial data-cleaning step?\n\nRespond as a tutor: give the correct answer, then justify it using the underlying concept.",
    "idealAnswer": "To rename factor levels. fct_recode() maps old factor labels to new labels.",
    "keyPoints": [
      "Names To rename factor levels as the correct answer.",
      "Explains that fct_recode() maps old factor labels to new labels."
    ],
    "explanation": "A complete correction identifies To rename factor levels and applies this rule: fct_recode() maps old factor labels to new labels.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk2_bilbos_ledgers.html",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "A logical vector marking missing values. is.na() tests each element and returns TRUE where the value is missing.",
    "keyPoints": [
      "Gives the answer: A logical vector marking missing values",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 105
  },
  {
    ...
    "week": "week-02",
    "topic": "R vectors, factors, and subsetting",
    "prompt": "Evaluate this attempted answer.\n\nQuestion: What does is.na(x) return?\n\nAttempt: **A count of missing values**\n\nReplace the attempt with the correct answer and briefly explain why the replacement is correct.",
    "idealAnswer": "A logical vector marking missing values. is.na() tests each element and returns TRUE where the value is missing.",
    "keyPoints": [
      "Names A logical vector marking missing values as the correct answer.",
      "Explains that is.na() tests each element and returns TRUE where the value is missing."
    ],
    "explanation": "A complete correction identifies A logical vector marking missing values and applies this rule: is.na() tests each element and returns TRUE where the value is missing.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk2_bilbos_ledgers.html",
  ...
  },
  {
    ...
    "week": "week-02",
    "topic": "R vectors, factors, and subsetting",
    "prompt": "A learner chose **&&** when asked: “Which operator combines logical tests elementwise in R?”\n\nCorrect the learner without referring to option letters. Your response must name the correct result and the rule that produces it.",
    "idealAnswer": "&. & is vectorised over elements; && only checks the first element of each side.",
    "keyPoints": [
      "Names & as the correct answer.",
      "Explains that & is vectorised over elements; && only checks the first element of each side."
    ],
    "explanation": "A complete correction identifies & and applies this rule: & is vectorised over elements; && only checks the first element of each side.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk2_bilbos_ledgers.html",
  ...
  },
  {
    ...
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "A student answers the following question with **Keeps rows satisfying a predicate**:\n\n> What does select(where(is.numeric)) do in dplyr?\n\nWrite a one- or two-sentence correction. State the better answer and explain the relevant rule or behavior.",
    "idealAnswer": "Keeps columns satisfying a predicate. where() applies a predicate to columns inside select().",
    "keyPoints": [
      "Names Keeps columns satisfying a predicate as the correct answer.",
      "Explains that where() applies a predicate to columns inside select()."
    ],
    "explanation": "A complete correction identifies Keeps columns satisfying a predicate and applies this rule: where() applies a predicate to columns inside select().",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  },
  {
    ...
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "During revision, a classmate claims **Multiple rows in arrange order** is the answer to this question:\n\n> What does mutate(across(...)) target?\n\nRespond as a tutor: give the correct answer, then justify it using the underlying concept.",
    "idealAnswer": "Multiple columns in one mutate step. across() lets mutate or summarise apply a function over selected columns.",
    "keyPoints": [
      "Names Multiple columns in one mutate step as the correct answer.",
      "Explains that across() lets mutate or summarise apply a function over selected columns."
    ],
    "explanation": "A complete correction identifies Multiple columns in one mutate step and applies this rule: across() lets mutate or summarise apply a function over selected columns.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "Sort by x descending, then y ascending for ties. arrange() uses later columns as tie-breakers.",
    "keyPoints": [
      "Gives the answer: Sort by x descending, then y ascending for ties",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 113
  },
  {
    ...
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "Evaluate this attempted answer.\n\nQuestion: Why use arrange(desc(x), y)?\n\nAttempt: **Filter x and y simultaneously**\n\nReplace the attempt with the correct answer and briefly explain why the replacement is correct.",
    "idealAnswer": "Sort by x descending, then y ascending for ties. arrange() uses later columns as tie-breakers.",
    "keyPoints": [
      "Names Sort by x descending, then y ascending for ties as the correct answer.",
      "Explains that arrange() uses later columns as tie-breakers."
    ],
    "explanation": "A complete correction identifies Sort by x descending, then y ascending for ties and applies this rule: arrange() uses later columns as tie-breakers.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  },
  {
    ...
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "A learner chose **One row per original observation** when asked: “What does summarize(mean_x = mean(x), .by = group) return?”\n\nCorrect the learner without referring to option letters. Your response must name the correct result and the rule that produces it.",
    "idealAnswer": "One summary row per group. .by groups for that summarise call.",
    "keyPoints": [
      "Names One summary row per group as the correct answer.",
      "Explains that .by groups for that summarise call."
    ],
    "explanation": "A complete correction identifies One summary row per group and applies this rule: .by groups for that summarise call.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  },
  {
    ...
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "A student answers the following question with **pivot_wider()**:\n\n> Which tidyr verb usually turns many measure columns into key-value rows?\n\nWrite a one- or two-sentence correction. State the better answer and explain the relevant rule or behavior.",
    "idealAnswer": "pivot_longer(). pivot_longer() makes a data set longer by gathering columns into rows.",
    "keyPoints": [
      "Names pivot_longer() as the correct answer.",
      "Explains that pivot_longer() makes a data set longer by gathering columns into rows."
    ],
    "explanation": "A complete correction identifies pivot_longer() and applies this rule: pivot_longer() makes a data set longer by gathering columns into rows.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "Rows with matching keys in both tables. inner_join() drops unmatched rows from either input.",
    "keyPoints": [
      "Gives the answer: Rows with matching keys in both tables",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 119
  },
  {
    ...
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "During revision, a classmate claims **All rows from the left table** is the answer to this question:\n\n> What does an inner_join keep?\n\nRespond as a tutor: give the correct answer, then justify it using the underlying concept.",
    "idealAnswer": "Rows with matching keys in both tables. inner_join() drops unmatched rows from either input.",
    "keyPoints": [
      "Names Rows with matching keys in both tables as the correct answer.",
      "Explains that inner_join() drops unmatched rows from either input."
    ],
    "explanation": "A complete correction identifies Rows with matching keys in both tables and applies this rule: inner_join() drops unmatched rows from either input.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  },
  {
    ...
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "Evaluate this attempted answer.\n\nQuestion: What does left_join(x, y, by = key) preserve?\n\nAttempt: **All rows from y only**\n\nReplace the attempt with the correct answer and briefly explain why the replacement is correct.",
    "idealAnswer": "All rows from x. A left join keeps the left table's rows and adds matching right-side columns.",
    "keyPoints": [
      "Names All rows from x as the correct answer.",
      "Explains that A left join keeps the left table's rows and adds matching right-side columns."
    ],
    "explanation": "A complete correction identifies All rows from x and applies this rule: A left join keeps the left table's rows and adds matching right-side columns.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "Applying a function to each element of a list/vector. purrr::map() iterates a function over elements and returns a list by default.",
    "keyPoints": [
      "Gives the answer: Applying a function to each element of a list/vector",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 123
  },
  {
    ...
    "week": "week-03",
    "topic": "Data wrangling with dplyr and tidyr",
    "prompt": "A learner chose **Changing axis limits** when asked: “What is map() commonly used for in tidyverse workflows?”\n\nCorrect the learner without referring to option letters. Your response must name the correct result and the rule that produces it.",
    "idealAnswer": "Applying a function to each element of a list/vector. purrr::map() iterates a function over elements and returns a list by default.",
    "keyPoints": [
      "Names Applying a function to each element of a list/vector as the correct answer.",
      "Explains that purrr::map() iterates a function over elements and returns a list by default."
    ],
    "explanation": "A complete correction identifies Applying a function to each element of a list/vector and applies this rule: purrr::map() iterates a function over elements and returns a list by default.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk3_tutorial-nyflights.html",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "A plot object with data and mappings. ggplot() initializes the plot; geoms add visible layers.",
    "keyPoints": [
      "Gives the answer: A plot object with data and mappings",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 125
  },
  {
    ...
    "week": "week-04",
    "topic": "ggplot layers and distributions",
    "prompt": "A student answers the following question with **A rendered PNG file**:\n\n> What object does ggplot(data, aes(...)) create before geoms are added?\n\nWrite a one- or two-sentence correction. State the better answer and explain the relevant rule or behavior.",
    "idealAnswer": "A plot object with data and mappings. ggplot() initializes the plot; geoms add visible layers.",
    "keyPoints": [
      "Names A plot object with data and mappings as the correct answer.",
      "Explains that ggplot() initializes the plot; geoms add visible layers."
    ],
    "explanation": "A complete correction identifies A plot object with data and mappings and applies this rule: ggplot() initializes the plot; geoms add visible layers.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk4-tutorial-iris.html",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "geom_line() orders by x; geom_path() follows row order. geom_path() connects observations in data order; geom_line() orders by x within groups.",
    "keyPoints": [
      "Gives the answer: geom_line() orders by x; geom_path() follows row order",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 127
  },
  {
    ...
    "week": "week-04",
    "topic": "ggplot layers and distributions",
    "prompt": "During revision, a classmate claims **geom_path() only draws points** is the answer to this question:\n\n> How does geom_line() differ from geom_path()?\n\nRespond as a tutor: give the correct answer, then justify it using the underlying concept.",
    "idealAnswer": "geom_line() orders by x; geom_path() follows row order. geom_path() connects observations in data order; geom_line() orders by x within groups.",
    "keyPoints": [
      "Names geom_line() orders by x; geom_path() follows row order as the correct answer.",
      "Explains that geom_path() connects observations in data order; geom_line() orders by x within groups."
    ],
    "explanation": "A complete correction identifies geom_line() orders by x; geom_path() follows row order and applies this rule: geom_path() connects observations in data order; geom_line() orders by x within groups.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk4-tutorial-iris.html",
  ...
  },
  {
    ...
    "week": "week-04",
    "topic": "ggplot layers and distributions",
    "prompt": "Evaluate this attempted answer.\n\nQuestion: Which geom can encode overlapping repeated points by count?\n\nAttempt: **geom_histogram()**\n\nReplace the attempt with the correct answer and briefly explain why the replacement is correct.",
    "idealAnswer": "geom_count(). geom_count() maps duplicate point counts to size.",
    "keyPoints": [
      "Names geom_count() as the correct answer.",
      "Explains that geom_count() maps duplicate point counts to size."
    ],
    "explanation": "A complete correction identifies geom_count() and applies this rule: geom_count() maps duplicate point counts to size.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk4-tutorial-iris.html",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "A fitted trend line with uncertainty band. geom_smooth() estimates and displays a smoothed relationship.",
    "keyPoints": [
      "Gives the answer: A fitted trend line with uncertainty band",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 131
  },
  {
    ...
    "week": "week-04",
    "topic": "ggplot layers and distributions",
    "prompt": "A learner chose **A histogram of x values** when asked: “What does geom_smooth() add by default to many scatterplots?”\n\nCorrect the learner without referring to option letters. Your response must name the correct result and the rule that produces it.",
    "idealAnswer": "A fitted trend line with uncertainty band. geom_smooth() estimates and displays a smoothed relationship.",
    "keyPoints": [
      "Names A fitted trend line with uncertainty band as the correct answer.",
      "Explains that geom_smooth() estimates and displays a smoothed relationship."
    ],
    "explanation": "A complete correction identifies A fitted trend line with uncertainty band and applies this rule: geom_smooth() estimates and displays a smoothed relationship.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk4-tutorial-iris.html",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "Number of bins across the x range. bins sets how many intervals the continuous variable is cut into.",
    "keyPoints": [
      "Gives the answer: Number of bins across the x range",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 133
  },
  {
    ...
    "week": "week-04",
    "topic": "ggplot layers and distributions",
    "prompt": "A student answers the following question with **Number of facet panels**:\n\n> What does bins control in geom_histogram()?\n\nWrite a one- or two-sentence correction. State the better answer and explain the relevant rule or behavior.",
    "idealAnswer": "Number of bins across the x range. bins sets how many intervals the continuous variable is cut into.",
    "keyPoints": [
      "Names Number of bins across the x range as the correct answer.",
      "Explains that bins sets how many intervals the continuous variable is cut into."
    ],
    "explanation": "A complete correction identifies Number of bins across the x range and applies this rule: bins sets how many intervals the continuous variable is cut into.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk4-tutorial-iris.html",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "To put histogram bars on a density scale. A density curve uses area 1; after_stat(density) makes histogram heights comparable.",
    "keyPoints": [
      "Gives the answer: To put histogram bars on a density scale",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 135
  },
  {
    ...
    "week": "week-04",
    "topic": "ggplot layers and distributions",
    "prompt": "During revision, a classmate claims **To convert x to a factor** is the answer to this question:\n\n> Why use after_stat(density) for a histogram combined with density?\n\nRespond as a tutor: give the correct answer, then justify it using the underlying concept.",
    "idealAnswer": "To put histogram bars on a density scale. A density curve uses area 1; after_stat(density) makes histogram heights comparable.",
    "keyPoints": [
      "Names To put histogram bars on a density scale as the correct answer.",
      "Explains that A density curve uses area 1; after_stat(density) makes histogram heights comparable."
    ],
    "explanation": "A complete correction identifies To put histogram bars on a density scale and applies this rule: A density curve uses area 1; after_stat(density) makes histogram heights comparable.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk4-tutorial-iris.html",
  ...
  },
  {
    ...
    "week": "week-04",
    "topic": "ggplot layers and distributions",
    "prompt": "Evaluate this attempted answer.\n\nQuestion: What does facet_wrap(~ group) do?\n\nAttempt: **Combines all groups into one row**\n\nReplace the attempt with the correct answer and briefly explain why the replacement is correct.",
    "idealAnswer": "Creates small multiples by group. Faceting repeats the same plot structure for each group level.",
    "keyPoints": [
      "Names Creates small multiples by group as the correct answer.",
      "Explains that Faceting repeats the same plot structure for each group level."
    ],
    "explanation": "A complete correction identifies Creates small multiples by group and applies this rule: Faceting repeats the same plot structure for each group level.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk4-tutorial-iris.html",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "When y values are already computed. geom_col() uses the supplied y values; geom_bar() counts by default.",
    "keyPoints": [
      "Gives the answer: When y values are already computed",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 139
  },
  {
    ...
    "week": "week-06",
    "topic": "Aesthetics, bars, rasters, and contours",
    "prompt": "A learner chose **When y should count rows** when asked: “When should geom_col() be preferred over geom_bar()?”\n\nCorrect the learner without referring to option letters. Your response must name the correct result and the rule that produces it.",
    "idealAnswer": "When y values are already computed. geom_col() uses the supplied y values; geom_bar() counts by default.",
    "keyPoints": [
      "Names When y values are already computed as the correct answer.",
      "Explains that geom_col() uses the supplied y values; geom_bar() counts by default."
    ],
    "explanation": "A complete correction identifies When y values are already computed and applies this rule: geom_col() uses the supplied y values; geom_bar() counts by default.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk6-tutorial-mpg.html",
  ...
  },
  {
    ...
    "week": "week-06",
    "topic": "Aesthetics, bars, rasters, and contours",
    "prompt": "A student answers the following question with **Uses y = 1 for every bar**:\n\n> What does geom_bar() do without a y aesthetic?\n\nWrite a one- or two-sentence correction. State the better answer and explain the relevant rule or behavior.",
    "idealAnswer": "Counts rows in each x category. The default stat for geom_bar() is count.",
    "keyPoints": [
      "Names Counts rows in each x category as the correct answer.",
      "Explains that The default stat for geom_bar() is count."
    ],
    "explanation": "A complete correction identifies Counts rows in each x category and applies this rule: The default stat for geom_bar() is count.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk6-tutorial-mpg.html",
  ...
  },
  {
    ...
    "week": "week-06",
    "topic": "Aesthetics, bars, rasters, and contours",
    "prompt": "During revision, a classmate claims **For unordered categories** is the answer to this question:\n\n> When is geom_raster() usually faster than geom_tile()?\n\nRespond as a tutor: give the correct answer, then justify it using the underlying concept.",
    "idealAnswer": "For regular grids with equal tile sizes. geom_raster() is optimized for regular raster grids.",
    "keyPoints": [
      "Names For regular grids with equal tile sizes as the correct answer.",
      "Explains that geom_raster() is optimized for regular raster grids."
    ],
    "explanation": "A complete correction identifies For regular grids with equal tile sizes and applies this rule: geom_raster() is optimized for regular raster grids.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk6-tutorial-mpg.html",
  ...
  },
  {
    ...
    "week": "week-06",
    "topic": "Aesthetics, bars, rasters, and contours",
    "prompt": "Evaluate this attempted answer.\n\nQuestion: In contour plots, what aesthetic supplies the third variable?\n\nAttempt: **shape**\n\nReplace the attempt with the correct answer and briefly explain why the replacement is correct.",
    "idealAnswer": "z. Contours trace levels of z over x-y space.",
    "keyPoints": [
      "Names z as the correct answer.",
      "Explains that Contours trace levels of z over x-y space."
    ],
    "explanation": "A complete correction identifies z and applies this rule: Contours trace levels of z over x-y space.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk6-tutorial-mpg.html",
  ...
  },
  {
    ...
    "week": "week-06",
    "topic": "Aesthetics, bars, rasters, and contours",
    "prompt": "A learner chose **Log scale** when asked: “Which aesthetic is generally best for unordered categories?”\n\nCorrect the learner without referring to option letters. Your response must name the correct result and the rule that produces it.",
    "idealAnswer": "Shape or qualitative colour. Categorical variables need discrete encodings.",
    "keyPoints": [
      "Names Shape or qualitative colour as the correct answer.",
      "Explains that Categorical variables need discrete encodings."
    ],
    "explanation": "A complete correction identifies Shape or qualitative colour and applies this rule: Categorical variables need discrete encodings.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk6-tutorial-mpg.html",
  ...
  },
  {
    ...
    "week": "week-06",
    "topic": "Aesthetics, bars, rasters, and contours",
    "prompt": "A student answers the following question with **Line width always means category**:\n\n> Why should line width be handled carefully for extensive quantities?\n\nWrite a one- or two-sentence correction. State the better answer and explain the relevant rule or behavior.",
    "idealAnswer": "Visual area/length can imply magnitude. Size-like aesthetics carry magnitude impressions and can mislead when scaled poorly.",
    "keyPoints": [
      "Names Visual area/length can imply magnitude as the correct answer.",
      "Explains that Size-like aesthetics carry magnitude impressions and can mislead when scaled poorly."
    ],
    "explanation": "A complete correction identifies Visual area/length can imply magnitude and applies this rule: Size-like aesthetics carry magnitude impressions and can mislead when scaled poorly.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk6-tutorial-mpg.html",
  ...
  },
  {
    ...
    "week": "week-08",
    "topic": "Scales and guides",
    "prompt": "During revision, a classmate claims **Breaks filter rows; limits rename labels** is the answer to this question:\n\n> What is the difference between limits and breaks on a scale?\n\nRespond as a tutor: give the correct answer, then justify it using the underlying concept.",
    "idealAnswer": "Limits set data range shown; breaks set tick positions. Scale limits define the displayed domain while breaks define guide marks.",
    "keyPoints": [
      "Names Limits set data range shown; breaks set tick positions as the correct answer.",
      "Explains that Scale limits define the displayed domain while breaks define guide marks."
    ],
    "explanation": "A complete correction identifies Limits set data range shown; breaks set tick positions and applies this rule: Scale limits define the displayed domain while breaks define guide marks.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk8_scales_and_guides_tutorial.html",
  ...
  },
  {
    ...
    "week": "week-08",
    "topic": "Scales and guides",
    "prompt": "Evaluate this attempted answer.\n\nQuestion: Which scale preserves proportional area for bubble sizes?\n\nAttempt: **scale_size_continuous()**\n\nReplace the attempt with the correct answer and briefly explain why the replacement is correct.",
    "idealAnswer": "scale_size_area(). scale_size_area() maps zero to zero and scales point area appropriately.",
    "keyPoints": [
      "Names scale_size_area() as the correct answer.",
      "Explains that scale_size_area() maps zero to zero and scales point area appropriately."
    ],
    "explanation": "A complete correction identifies scale_size_area() and applies this rule: scale_size_area() maps zero to zero and scales point area appropriately.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk8_scales_and_guides_tutorial.html",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "guides(linewidth = guide_legend(reverse = TRUE)). guide_legend(reverse = TRUE) controls legend key ordering.",
    "keyPoints": [
      "Gives the answer: guides(linewidth = guide_legend(reverse = TRUE))",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 155
  },
  {
    ...
    "week": "week-08",
    "topic": "Scales and guides",
    "prompt": "A learner chose **scale_linewidth(reverse = TRUE)** when asked: “Which guide call reverses a linewidth legend?”\n\nCorrect the learner without referring to option letters. Your response must name the correct result and the rule that produces it.",
    "idealAnswer": "guides(linewidth = guide_legend(reverse = TRUE)). guide_legend(reverse = TRUE) controls legend key ordering.",
    "keyPoints": [
      "Names guides(linewidth = guide_legend(reverse = TRUE)) as the correct answer.",
      "Explains that guide_legend(reverse = TRUE) controls legend key ordering."
    ],
    "explanation": "A complete correction identifies guides(linewidth = guide_legend(reverse = TRUE)) and applies this rule: guide_legend(reverse = TRUE) controls legend key ordering.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk8_scales_and_guides_tutorial.html",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "To make legend keys readable without changing the plotted data. override.aes affects legend display, not the data layer.",
    "keyPoints": [
      "Gives the answer: To make legend keys readable without changing the plotted data",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 157
  },
  {
    ...
    "week": "week-08",
    "topic": "Scales and guides",
    "prompt": "A student answers the following question with **To change raw data values**:\n\n> Why override legend aesthetics?\n\nWrite a one- or two-sentence correction. State the better answer and explain the relevant rule or behavior.",
    "idealAnswer": "To make legend keys readable without changing the plotted data. override.aes affects legend display, not the data layer.",
    "keyPoints": [
      "Names To make legend keys readable without changing the plotted data as the correct answer.",
      "Explains that override.aes affects legend display, not the data layer."
    ],
    "explanation": "A complete correction identifies To make legend keys readable without changing the plotted data and applies this rule: override.aes affects legend display, not the data layer.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk8_scales_and_guides_tutorial.html",
  ...
  },
  {
    ...
    "week": "week-08",
    "topic": "Scales and guides",
    "prompt": "During revision, a classmate claims **Sequential** is the answer to this question:\n\n> Which ColorBrewer family is appropriate for nominal categories?\n\nRespond as a tutor: give the correct answer, then justify it using the underlying concept.",
    "idealAnswer": "Qualitative. Nominal categories need distinct hues rather than ordered ramps.",
    "keyPoints": [
      "Names Qualitative as the correct answer.",
      "Explains that Nominal categories need distinct hues rather than ordered ramps."
    ],
    "explanation": "A complete correction identifies Qualitative and applies this rule: Nominal categories need distinct hues rather than ordered ramps.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk8_scales_and_guides_tutorial.html",
  ...
  },
  {
    ...
    "week": "week-08",
    "topic": "Scales and guides",
    "prompt": "Evaluate this attempted answer.\n\nQuestion: Which palette family is suited to ordered low-to-high values?\n\nAttempt: **Qualitative**\n\nReplace the attempt with the correct answer and briefly explain why the replacement is correct.",
    "idealAnswer": "Sequential. Sequential palettes communicate magnitude progression.",
    "keyPoints": [
      "Names Sequential as the correct answer.",
      "Explains that Sequential palettes communicate magnitude progression."
    ],
    "explanation": "A complete correction identifies Sequential and applies this rule: Sequential palettes communicate magnitude progression.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk8_scales_and_guides_tutorial.html",
  ...
  },
  {
    ...
    "week": "week-09",
    "topic": "Coordinates, facets, and themes",
    "prompt": "A learner chose **Changes the data values** when asked: “What does coord_flip() mainly do?”\n\nCorrect the learner without referring to option letters. Your response must name the correct result and the rule that produces it.",
    "idealAnswer": "Swaps x and y display axes. Coordinate systems affect how layers are drawn after data/stat transformations.",
    "keyPoints": [
      "Names Swaps x and y display axes as the correct answer.",
      "Explains that Coordinate systems affect how layers are drawn after data/stat transformations."
    ],
    "explanation": "A complete correction identifies Swaps x and y display axes and applies this rule: Coordinate systems affect how layers are drawn after data/stat transformations.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/week_09_coord_facets_and_themes_tutorial.html"
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "Zooms display without dropping data before stats. coord_cartesian() is a visual zoom; scale limits can remove data before stats are computed.",
    "keyPoints": [
      "Gives the answer: Zooms display without dropping data before stats",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 165
  },
  {
    ...
    "week": "week-09",
    "topic": "Coordinates, facets, and themes",
    "prompt": "A student answers the following question with **Drops data before every statistic**:\n\n> What does coord_cartesian(xlim = ...) do compared with scale_x_continuous(limits = ...)?\n\nWrite a one- or two-sentence correction. State the better answer and explain the relevant rule or behavior.",
    "idealAnswer": "Zooms display without dropping data before stats. coord_cartesian() is a visual zoom; scale limits can remove data before stats are computed.",
    "keyPoints": [
      "Names Zooms display without dropping data before stats as the correct answer.",
      "Explains that coord_cartesian() is a visual zoom; scale limits can remove data before stats are computed."
    ],
    "explanation": "A complete correction identifies Zooms display without dropping data before stats and applies this rule: coord_cartesian() is a visual zoom; scale limits can remove data before stats are computed.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/week_09_coord_facets_and_themes_tutorial.html"
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "Crossing two faceting variables into a grid. facet_grid() lays out panels by row and column variables.",
    "keyPoints": [
      "Gives the answer: Crossing two faceting variables into a grid",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 167
  },
  {
    ...
    "week": "week-09",
    "topic": "Coordinates, facets, and themes",
    "prompt": "During revision, a classmate claims **Changing point shapes** is the answer to this question:\n\n> What is facet_grid(rows ~ cols) useful for?\n\nRespond as a tutor: give the correct answer, then justify it using the underlying concept.",
    "idealAnswer": "Crossing two faceting variables into a grid. facet_grid() lays out panels by row and column variables.",
    "keyPoints": [
      "Names Crossing two faceting variables into a grid as the correct answer.",
      "Explains that facet_grid() lays out panels by row and column variables."
    ],
    "explanation": "A complete correction identifies Crossing two faceting variables into a grid and applies this rule: facet_grid() lays out panels by row and column variables.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/week_09_coord_facets_and_themes_tutorial.html"
  ...
  },
  {
    ...
    "week": "week-09",
    "topic": "Coordinates, facets, and themes",
    "prompt": "Evaluate this attempted answer.\n\nQuestion: What does theme_minimal() change?\n\nAttempt: **The underlying data**\n\nReplace the attempt with the correct answer and briefly explain why the replacement is correct.",
    "idealAnswer": "Non-data styling elements. Themes control appearance such as backgrounds, grids, and text.",
    "keyPoints": [
      "Names Non-data styling elements as the correct answer.",
      "Explains that Themes control appearance such as backgrounds, grids, and text."
    ],
    "explanation": "A complete correction identifies Non-data styling elements and applies this rule: Themes control appearance such as backgrounds, grids, and text.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/week_09_coord_facets_and_themes_tutorial.html"
  ...
  },
  {
    ...
    "week": "week-09",
    "topic": "Coordinates, facets, and themes",
    "prompt": "A learner chose **mutate()** when asked: “Where should axis title and legend position usually be adjusted?”\n\nCorrect the learner without referring to option letters. Your response must name the correct result and the rule that produces it.",
    "idealAnswer": "theme(). theme() controls non-data components including text and legend placement.",
    "keyPoints": [
      "Names theme() as the correct answer.",
      "Explains that theme() controls non-data components including text and legend placement."
    ],
    "explanation": "A complete correction identifies theme() and applies this rule: theme() controls non-data components including text and legend placement.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/week_09_coord_facets_and_themes_tutorial.html"
  ...
  },
  {
    ...
    "week": "week-10",
    "topic": "Geospatial vectors",
    "prompt": "A student answers the following question with **factor object**:\n\n> What kind of object is commonly used for vector geospatial data in R?\n\nWrite a one- or two-sentence correction. State the better answer and explain the relevant rule or behavior.",
    "idealAnswer": "sf object. The sf package stores simple-feature geometries with attribute columns.",
    "keyPoints": [
      "Names sf object as the correct answer.",
      "Explains that The sf package stores simple-feature geometries with attribute columns."
    ],
    "explanation": "A complete correction identifies sf object and applies this rule: The sf package stores simple-feature geometries with attribute columns.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk10_geospatial_vectors_tutorial.html",
  ...
  },
  {
    ...
    "week": "week-10",
    "topic": "Geospatial vectors",
    "prompt": "During revision, a classmate claims **geom_bar()** is the answer to this question:\n\n> Which geom is commonly used to draw sf geometries in ggplot2?\n\nRespond as a tutor: give the correct answer, then justify it using the underlying concept.",
    "idealAnswer": "geom_sf(). geom_sf() understands simple-feature geometry columns.",
    "keyPoints": [
      "Names geom_sf() as the correct answer.",
      "Explains that geom_sf() understands simple-feature geometry columns."
    ],
    "explanation": "A complete correction identifies geom_sf() and applies this rule: geom_sf() understands simple-feature geometry columns.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk10_geospatial_vectors_tutorial.html",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "It controls how geographic coordinates are projected to the plane. CRS/projection affects shapes, distances, and areas on a flat display.",
    "keyPoints": [
      "Gives the answer: It controls how geographic coordinates are projected to the plane",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 177
  },
  {
    ...
    "week": "week-10",
    "topic": "Geospatial vectors",
    "prompt": "Evaluate this attempted answer.\n\nQuestion: Why does coordinate reference system matter for maps?\n\nAttempt: **It decides which rows are missing**\n\nReplace the attempt with the correct answer and briefly explain why the replacement is correct.",
    "idealAnswer": "It controls how geographic coordinates are projected to the plane. CRS/projection affects shapes, distances, and areas on a flat display.",
    "keyPoints": [
      "Names It controls how geographic coordinates are projected to the plane as the correct answer.",
      "Explains that CRS/projection affects shapes, distances, and areas on a flat display."
    ],
    "explanation": "A complete correction identifies It controls how geographic coordinates are projected to the plane and applies this rule: CRS/projection affects shapes, distances, and areas on a flat display.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk10_geospatial_vectors_tutorial.html",
  ...
  },
  {
    ...
    "week": "week-10",
    "topic": "Geospatial vectors",
    "prompt": "A learner chose **Rows based only on string equality** when asked: “What does st_join() usually combine?”\n\nCorrect the learner without referring to option letters. Your response must name the correct result and the rule that produces it.",
    "idealAnswer": "Attributes based on spatial relationships. Spatial joins use geometry relationships such as intersects or within.",
    "keyPoints": [
      "Names Attributes based on spatial relationships as the correct answer.",
      "Explains that Spatial joins use geometry relationships such as intersects or within."
    ],
    "explanation": "A complete correction identifies Attributes based on spatial relationships and applies this rule: Spatial joins use geometry relationships such as intersects or within.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk10_geospatial_vectors_tutorial.html",
  ...
  },
  {
    ...
    "week": "week-10",
    "topic": "Geospatial vectors",
    "prompt": "A student answers the following question with **A time series by line width**:\n\n> What is a choropleth map usually encoding?\n\nWrite a one- or two-sentence correction. State the better answer and explain the relevant rule or behavior.",
    "idealAnswer": "A value by fill colour across areas. Choropleths colour polygons by a variable.",
    "keyPoints": [
      "Names A value by fill colour across areas as the correct answer.",
      "Explains that Choropleths colour polygons by a variable."
    ],
    "explanation": "A complete correction identifies A value by fill colour across areas and applies this rule: Choropleths colour polygons by a variable.",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "tut/wk10_geospatial_vectors_tutorial.html",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "It reverses the ordering before the rank is computed.. `desc()` reverses the ordering so the largest value receives the smallest rank number.",
    "keyPoints": [
      "Gives the answer: It reverses the ordering before the rank is computed.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 198
  },
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "Sorts by `n_flights` descending, then by `carrier` for ties.. `arrange()` sorts by the first expression and uses later expressions as tie-breakers.",
    "keyPoints": [
      "Gives the answer: Sorts by `n_flights` descending, then by `carrier` for ties.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 206
  },
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "The appearance of legend keys.. `override.aes` changes how legend keys are drawn, not the plotted data.",
    "keyPoints": [
      "Gives the answer: The appearance of legend keys.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 229
  },
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "To make large numbers easier to read without changing their values.. Formatting labels changes presentation only; values remain the same.",
    "keyPoints": [
      "Gives the answer: To make large numbers easier to read without changing their values.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 232
  },
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "A scale setting such as axis position.. Axis placement is a scale/guide display setting, not a data transformation.",
    "keyPoints": [
      "Gives the answer: A scale setting such as axis position.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 234
  },
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "Rows outside the limits may be removed before the statistic is computed.. Scale limits can remove data before statistical transformations, affecting fitted lines and summaries.",
    "keyPoints": [
      "Gives the answer: Rows outside the limits may be removed before the statistic is computed.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 237
  },
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "Non-data visual elements such as text, backgrounds, grids, and legend position.. Themes control presentation components, not data values.",
    "keyPoints": [
      "Gives the answer: Non-data visual elements such as text, backgrounds, grids, and legend position.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 239
  },
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "When equal units on x and y should have equal physical lengths on screen.. `coord_fixed()` fixes the aspect ratio so one x unit and one y unit use a specified screen ratio.",
    "keyPoints": [
      "Gives the answer: When equal units on x and y should have equal physical lengths on screen.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 242
  },
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "Within-panel patterns may be easier to see, but cross-panel magnitude comparisons become harder.. Free scales can reveal local patterns but reduce direct comparison of absolute values across panels.",
    "keyPoints": [
      "Gives the answer: Within-panel patterns may be easier to see, but cross-panel magnitude comparisons become harder.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 250
  },
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "theme(legend.position = ...). Legend position is a theme setting.",
    "keyPoints": [
      "Gives the answer: theme(legend.position = ...)",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 253
  },
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "Layers must use compatible coordinate systems to align correctly.. Coordinate reference systems define how coordinates map to locations; incompatible CRS can misalign layers.",
    "keyPoints": [
      "Gives the answer: Layers must use compatible coordinate systems to align correctly.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 257
  },
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "Spatial relationships between geometries.. `st_join()` joins using geometry relationships such as intersects or within.",
    "keyPoints": [
      "Gives the answer: Spatial relationships between geometries.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 259
  },
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "It understands the geometry column and draws the appropriate spatial features.. `geom_sf()` handles sf geometry columns directly.",
    "keyPoints": [
      "Gives the answer: It understands the geometry column and draws the appropriate spatial features.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 262
  },
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "A rate can account for different denominators across areas.. Rates can make areas with different denominators more comparable; raw counts may mostly reflect population size.",
    "keyPoints": [
      "Gives the answer: A rate can account for different denominators across areas.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 265
  },
  ...
  },
  {
    "type": "open",
    "week": "week-10",
    "prompt": "Four world maps use different projections. Which visible grid pattern identifies the equirectangular projection?\n\nAnswer without options, then justify your answer in one sentence.",
    ...
    "needsReview": false,
    "idealAnswer": "Straight vertical meridians and straight horizontal parallels in a rectangular grid.. An equirectangular map has a rectangular latitude-longitude grid with straight meridians and parallels.",
    "keyPoints": [
      "Gives the answer: Straight vertical meridians and straight horizontal parallels in a rectangular grid.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 267
  },
  {
    ...
    "prompt": "A bubble plot maps each planning area's resident population to circle size. Select every reason `scale_size_area()` is preferred to a radius-based or log-transformed size scale.",
    "options": [
  ...
  },
  {
    ...
    "week": "practice-2",
    "topic": "Practice 2 extension",
    "prompt": "You inherit a planning-area bubble plot with non-proportional sizes, an unsuitable ordered colour palette for nominal regions, several region-specific smoothers instead of one overall fit, and unfinished labels. Put the repair stages in a defensible order.",
    "items": [
    ...
    "explanation": "Repair the quantitative size encoding first, then categorical colour and model grouping, before final presentation polish.",
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "Region is nominal, so distinct qualitative hues are appropriate.. Nominal categories need distinct hues rather than an ordered light-to-dark ramp.",
    "keyPoints": [
      "Gives the answer: Region is nominal, so distinct qualitative hues are appropriate.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 274
  },
  ...
  },
  {
    ...
    "week": "practice-2",
    "topic": "Practice 2 extension",
    "prompt": "Inspect the pre-publication planning-area plot below. Select every issue that still needs attention.\n\n![Pre-publication planning-area bubble plot](artifacts/pre-polish-plot.png)",
    "options": [
    ...
    "promptHtml": "<p>Inspect the pre-publication planning-area plot below. Select every issue that still needs attention.</p><p><img src=\"artifacts/pre-polish-plot.png\" alt=\"Pre-publication planning-area bubble plot with technical labels, scientific notation, and crowded labels\" style=\"max-width: 100%;\"></p>",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "practice-quiz/quiz2-1.html",
  ...
  },
  {
    ...
    "week": "practice-2",
    "topic": "Practice 2 extension",
    "prompt": "A bubble plot uses circle area to represent population. A reviewer proposes applying a logarithmic transform to population before mapping it to bubble area so that small areas become more visible. Select every true consequence of that change.",
    "options": [
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "The axes use different units, so equal screen distances are not inherently meaningful.. A fixed aspect ratio is meaningful when unit equality across axes has a clear interpretation; years and persons are different units.",
    "keyPoints": [
      "Gives the answer: The axes use different units, so equal screen distances are not inherently meaningful.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 279
  },
  ...
  },
  {
    ...
    "week": "practice-2",
    "topic": "Practice 2 extension",
    "prompt": "The chart below compares Wall Street Journal topic coverage before and after an ownership change. Select every redesign that would make the comparison easier to measure.\n\n![Three-dimensional before-and-after coverage chart](artifacts/murdoch%20copy.png)",
    "options": [
    ...
    "promptHtml": "<p>The chart below compares Wall Street Journal topic coverage before and after an ownership change. Select every redesign that would make the comparison easier to measure.</p><p><img src=\"artifacts/murdoch%20copy.png\" alt=\"Three-dimensional before-and-after newspaper coverage chart\" style=\"max-width: 100%;\"></p>",
    "source": {
      "kind": "source-derived-drill",
      "paths": [
        "practice-quiz/quiz2-1.html",
  ...
  },
  {
    ...
    "week": "practice-2",
    "topic": "Practice 2 extension",
    "prompt": "Consider this code. Why does the connecting line remain black while the points vary by year?\n\n```r\nggplot(pelts, aes(hare, lynx)) +\n  geom_line() +\n  geom_point(aes(colour = year)) +\n  scale_colour_distiller(palette = \"YlOrRd\")\n```",
    "options": [
  ...
  },
  {
    ...
    "week": "practice-2",
    "topic": "Practice 2 extension",
    "prompt": "Four world maps use different projections. Which visual clue identifies the equirectangular projection?\n\nAnswer without options, then justify your answer in one sentence.",
    ...
    "needsReview": false,
    "idealAnswer": "Straight meridians and parallels forming a rectangular grid.. The equirectangular projection displays latitude and longitude as straight grid lines in a rectangle.",
    "keyPoints": [
      "Gives the answer: Straight meridians and parallels forming a rectangular grid.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 283
  },
  ...
  },
  {
    ...
    "week": "practice-2",
    "topic": "Practice 2 extension",
    "prompt": "A three-dimensional chart compares topic-coverage percentages before and after a newspaper ownership change. Put the redesign process in order so readers can compare the two values for each topic accurately.",
    "items": [
  ...
  },
  {
    ...
    "needsReview": false,
    "idealAnswer": "Short readable labels reduce decoding effort without changing the data.. Readable labels improve interpretation while preserving the underlying values.",
    "keyPoints": [
      "Gives the answer: Short readable labels reduce decoding effort without changing the data.",
      "Provides a relevant conceptual or behavioral justification."
    ],
    "number": 286
  },
